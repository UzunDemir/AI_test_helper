...
st.sidebar.write(
        """
                     ...
                     1. Как это работает? Студент загружает учебный материал в pdf. AI-ассистент отвечает на тесты, выбирая правильные ответы. Точность ответов на тестировании составила 88%.
                     
                     2. Почему не воспользоваться обычными чатами (GPT, DeepSeek и т. д.)? Несмотря на то что модель обучена на огромном 
